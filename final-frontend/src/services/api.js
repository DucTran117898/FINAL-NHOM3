/**
 * API Service - Vue.js HTTP Client
...
export const teacherService = {
  ...
  search: (keyword = '', specialized = '') => {
    ...
    const queryString = params.toString()
    const suffix = queryString ? `?${queryString}` : ''
    return apiClient.get(`/api/teachers${suffix}`)
  },
}
